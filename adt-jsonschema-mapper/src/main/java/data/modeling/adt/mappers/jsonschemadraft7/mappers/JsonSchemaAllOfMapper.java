...
public class JsonSchemaAllOfMapper extends data.modeling.adt.mappers.jsonschemadraft7.mappers.JsonSchemaMapper<ProductType> {
    ...
    public ProductType toAdt(Map<String, Object> value) throws AdtException {
        ...
        if(allOf.size() == 1){
            ...
            if(!jsonSchemaAllOfObjects.isEmpty()) {
                ...
                return new data.modeling.adt.mappers.jsonschemadraft7.mappers.JsonSchemaObjectMapper(toAdtMapperRegistry, extendedProductTypes).toAdt(mergedJsonSchemaObjects);
            } else {
