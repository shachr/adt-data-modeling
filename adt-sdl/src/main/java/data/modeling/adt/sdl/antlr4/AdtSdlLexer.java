...
public class AdtSdlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "ENTITY", "RELATIONSHIP", 
			"ANNO", "SET", "IMPORT", "TO", "ENUM", "UNION", "MODIFY", "TYPE", "ANYOF", 
			"ALLOF", "DTO", "EXTENDS", "REMOVE", "RENAME", "DEFINE", "OVERRIDE", 
			"CONTEXT", "LBRACE", "RBRACE", "COLON", "EQ", "FALSE", "TRUE", "IDENTIFIER", 
	...
	public AdtSdlLexer(CharStream input) {
		super(input);
